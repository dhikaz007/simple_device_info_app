...
class AcceleroChartsPage extends StatelessWidget {
  const AcceleroChartsPage({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Accelerometer with charts'),
      ),
      body: Padding(
        ...
        child: Consumer<AccelerometerProvider>(
          builder: (context, provider, __) {
            final dataAccelero = provider.dataList;
            if (dataAccelero.isNotEmpty) {
              return Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        'x : ${dataAccelero.last.x.toStringAsFixed(3)} m/s²',
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: AppSpacing.space4),
                      Text(
                        'y : ${dataAccelero.last.y.toStringAsFixed(3)} m/s²',
                        style: Theme.of(context).textTheme.titleSmall?.copyWith(
                              color: AppColor.primaryWhite,
                              fontWeight: FontWeight.bold,
                            ),
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: AppSpacing.space4),
                      Text(
                        'z : ${dataAccelero.last.z.toStringAsFixed(3)} m/s²',
                        style: Theme.of(context).textTheme.titleSmall?.copyWith(
                              color: AppColor.primaryWhite,
                              fontWeight: FontWeight.bold,
                            ),
                  ...
                  SizedBox(
                    ...
                    child: SfCartesianChart(
                      ...
                      series: [
                        LineSeries<AccelerometerModel, double>(
                          dataSource: dataAccelero,
                          name: 'X',
                          color: Colors.red,
